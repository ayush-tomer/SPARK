...
import { Heart, MessageCircle, MoreHorizontal, Share, X, ImageIcon, Smile, Sparkles, Edit, Trash2 } from "lucide-react"
...
export default function SocialFeed() {
  ...
  return (
    <div className="max-w-5xl mx-auto bg-gradient-to-b from-gray-950 to-purple-950 min-h-screen border-x border-purple-900/50 shadow-2xl text-gray-200">
          ...
          posts.map((post) => (
            ...
            >
              <div className="flex space-x-3 sm:space-x-5">
                {/* Custom Avatar with gradient border */}
                            ...
                            <div className="flex-1">
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-1 sm:space-x-1.5 flex-wrap">
                                  ...
                                  <span className="text-gray-400">@{comment.username}</span>
                                  <span className="text-gray-500">•</span>
                                  <span className="text-gray-400 hover:underline cursor-pointer">
                                ...
                                <div className="relative">
                                  <button
                                    ...
                                    onClick={() =>
                                      setOpenCommentDropdown(openCommentDropdown === comment.id ? null : comment.id)
                                    }
                                  >
